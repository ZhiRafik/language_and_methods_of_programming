...
Шаг 1: определить max = максимум массива -> Шаг 2
Шаг 2: exp = 1 -> Шаг 3
Шаг 3: если max/exp = 0, то переход на Шаг 10 -> иначе -> Шаг 4
Шаг 4: обнулить count[0..9] -> Шаг 5
Шаг 5: пройти массив, увеличить count[(A[i]/exp)%10] -> Шаг 6
Шаг 6: преобразовать count в префиксные суммы -> Шаг 7
Шаг 7: заполнить выходной массив output согласно count -> Шаг 8
Шаг 8: скопировать output обратно в A -> Шаг 9
Шаг 9: exp = exp * 10 -> переход на Шаг 3
Шаг 10: конец
*/